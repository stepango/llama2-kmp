...
import Context from "https://deno.land/std@0.208.0/wasi/snapshot_preview1.ts";
...
//            runTask {
//                println(name)
//                args(arguments.orNull?.plus("--experimental-wasm-gc")?.split(" ") ?: emptyList<String>())
//            }
        }
        binaries.executable()
    }
