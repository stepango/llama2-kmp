...
@file:OptIn(UnsafeWasmMemoryApi::class, UnsafeWasmMemoryApi::class)
...
internal fun argsGet(): List<String> {
    ...
    withScopedMemoryAllocator { allocator ->
        ...
        if (ret != 0) {
            throw WasiException(Errno.entries[ret].ordinal)
        }
...
class WasiException(val errno: Int) : Exception("WASI error: $errno")
